...
void lv_time_attack_ui_init(void (*startStopCb)(), void (*resetCb)()) {
  ...
  refs.driver = lv_label_create(refs.screen);
  lv_label_set_text(refs.driver, "Driver 1");
  lv_obj_set_style_text_color(refs.driver, lv_color_hex(0x8fa0b6), 0);
  lv_obj_set_style_text_font(refs.driver, &lv_font_montserrat_20, 0);
  lv_obj_align(refs.driver, LV_ALIGN_TOP_RIGHT, -16, 12);
  ...
  lv_obj_align(refs.lapTime, LV_ALIGN_TOP_MID, 0, 48);
  ...
  lv_obj_align(refs.deltaPill, LV_ALIGN_TOP_MID, 0, 116);
  ...
  lv_obj_align(refs.bestLabel, LV_ALIGN_TOP_LEFT, 16, 176);
  ...
  lv_obj_align(refs.lapLabel, LV_ALIGN_TOP_RIGHT, -16, 176);
  ...
  lv_obj_align(refs.sessionLabel, LV_ALIGN_TOP_MID, 0, 206);
