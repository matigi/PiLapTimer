...
void lv_time_attack_ui_init(void (*startStopCb)(),
  ...
  lv_obj_set_width(refs.lapOverlayTime, 200);
  lv_obj_set_style_text_align(refs.lapOverlayTime, LV_TEXT_ALIGN_CENTER, 0);
  ...
  lv_obj_set_width(refs.lapOverlayDelta, 180);
  lv_obj_set_style_text_align(refs.lapOverlayDelta, LV_TEXT_ALIGN_CENTER, 0);
